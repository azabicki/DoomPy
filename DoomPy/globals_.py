...
plr['trait_pile'] = []
plr['n_tp'] = []
plr['n_tp_xtra'] = []           # xtra additions to count of traits -> see "River Mist" MOL
plr['n_tp_score'] = []          # what is shown on scoreboard -> shows if xtra is added due to some effects
plr['trait_selected'] = []
