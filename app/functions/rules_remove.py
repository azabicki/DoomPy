    ...
    match trait:
        case "Ironwood":
            ...
            if cur_effects != "none":
                ...
                print(
                    ["*"],
                    ">>> trait pile <<< '{}' (id:{}) does not protect anymore".format(
                        trait, trait_idx
                    ),
                )
        ...
        case "Spores":
            # save player id for each time spores is discarded! this string,
            # which becomes longer every time spores is discarded, is checked
            # during update_genes()
